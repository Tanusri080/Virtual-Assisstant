...
import action
root = Tk()
root.title("Conversational AI companion")
...
text_label = Label(frame , text="AI Assisstant" , font=("comic Sans ms" , 14 , "bold") , highlightbackground="#356696")
text_label.grid(row = 0 , column = 0 , padx = 20 , pady = 10)


# image
image = ImageTk.PhotoImage(Image.open("C:\\Users\\THANU SRI\\Downloads\\pnggg (1) (1).png"))
...
entry.place(x = 75 , y = 500 , width = 350 , height = 30)
